...
In order to use {turbolinks}[https://github.com/rails/turbolinks/], the maps api has to be included on
the initial page load. 

Therefore, include the `gmaps4rails_api_script_tags` helper call in your layout file:
