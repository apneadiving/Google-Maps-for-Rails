...
3) Javascript Dependencies:
  ...
  3.1) Insert google scripts in your dom: 

      <script src="//maps.google.com/maps/api/js?key=[your API key]"></script>

  3.2) Dependencies: you can use external files or create your own:

    3.2.1) Using the external files:

      <script src="//cdn.rawgit.com/mahnunchik/markerclustererplus/master/dist/markerclusterer.min.js"></script>
      <script src='//cdn.rawgit.com/printercu/google-maps-utility-library-v3-read-only/master/infobox/src/infobox_packed.js' type='text/javascript'></script> <!-- only if you need custom infoboxes -->

    3.2.2) Create your own JS file

      Get the JS code on: https://raw.githubusercontent.com/googlemaps/js-marker-clusterer/gh-pages/src/markerclusterer.js
      Save the markerclusterer.js and put in the file: app/assets/javascripts
      Import the JS in to the application: 
        <%= javascript_include_tag 'markerclusterer.js' %>
      Add the file to the precompile assets on config/initializers/assets.rb with the code:
