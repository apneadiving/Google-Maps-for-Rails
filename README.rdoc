...
Create a migration and add the following fields to your table (here users):
	...
	add_column :users, :latitude, :float #you can change the name if necessary, see wiki
	add_column :users, :longitude, :float #you can change the name if necessary, see wiki
