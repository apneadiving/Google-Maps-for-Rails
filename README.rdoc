...
Check out the {Getting Started}[https://github.com/apneadiving/Google-Maps-for-Rails/wiki/Getting-Started] page 
on the wiki and the companion {quick tutorial}[http://www.youtube.com/watch?v=R0l-7en3dUw&feature=youtu.be] 
video on youtube.
