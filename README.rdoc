...
Create a migration and add the following fields to your table (here users):
	...
	add_column :users, :gmaps4rails_latitude, :float #you can change the name if necessary, see wiki
	add_column :users, :gmaps4rails_longitude, :float #you can change the name if necessary, see wiki
